...
alpha2  = [0.8; .7; .9];    % exponent 
delta2  = [3; 6; 1];    % coefficient of captain random effects
beta2   = [0.3; 0.1];        % coefficient of ship chars (weight and type).
gamma02 = 1.4;                % intercept for zero‐vs‐positive
gamma12 = .2;                % slope on log(w_{1vj})
Tsim2 = IE9_gen_data(C, J, Vmax, s_omega, alpha2, delta2, beta2, gamma02, gamma12);
% prepare data vectors
n2     = size(Tsim2,1);
d2     = Tsim2.isPositive;
Y2     = Tsim2.Y_vj;
