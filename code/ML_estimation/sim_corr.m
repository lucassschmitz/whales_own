...
% parameter guess. 
in_beta   = [0.02; 0.02; 0.02];          % initial β's
in_alpha     = [1.3;.8; .82];       % initial   α's (α=1)
in_delta = [2 ; 2; 2]; %6:8
...
a_c = -0.6; d_v = d(157:159); Y_v = Y(157:159); x_v = Xmat(157,:)'; tau_v = Tau(157); 
...
a_c = 0; 
theta = theta_real; 
res5 = L_c_corr(theta_real, a_c, d_c, Y_c, x_c, tau_c, xk, wk, xk2, wk2, xk3, wk3); 
res51 = L_c_corr(theta0, a_c, d_c, Y_c, x_c, tau_c, xk, wk, xk2, wk2, xk3, wk3); 



res6 = L_c_corr_int(theta_real, d_c, Y_c, x_c, tau_c, xk, wk, xk2, wk2, xk3, wk3); 
res61 = L_c_corr_int(theta0, d_c, Y_c, x_c, tau_c, xk, wk, xk2, wk2, xk3, wk3); 
%%
...
num_inits = 1; % different starting points 
